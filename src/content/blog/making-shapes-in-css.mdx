...
This project was a fun project I Did where I tried to replicate some brand and app logos in HTML and CSS. You can check out the project [here](https://virajs00.github.io/css-logos/).

This project is inspired by this YouTube video by Web Dev Simplified where he tried to [make emojis in css](https://www.youtube.com/watch?v=P3LXA6duP5g).
...
The setting width and height to “0” is super important since otherwise it will not look like a triangle.
