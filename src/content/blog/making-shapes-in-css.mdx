...
import { BorderRadiusExample } from "../../components/articles/border-radius-example";
...
<BorderRadiusExample client:visible />

These are maily the things I used for [this project](https://virajs00.github.io/css-logos/). There are many other creative ways to have fun with CSS.
