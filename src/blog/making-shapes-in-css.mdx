...
import Triangle from "../components/articles/triangle.astro";
import SolidGradientExample from "../components/articles/solid-gradient.astro";
import BorderRadiusExample from "../components/articles/border-radius-example.astro";
